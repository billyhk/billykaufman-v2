...
- **Projects filmstrip** — featured + sidebar filmstrip layout; click to switch projects
...
src/
  ...
  components/        # UI components + canvas games
...
- `bio.ts` — name, title, paragraphs, `IS_OPEN_TO_WORK` flag
